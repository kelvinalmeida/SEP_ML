...
from routes.orchestrator.agente_control.agente_control_routes import agente_control_orchestrator_bp
...
app.register_blueprint(agente_control_orchestrator_bp)
